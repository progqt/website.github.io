...
<body>
	<div class="wrapper">
		...
		<form action="https://e3vwdl4bpd.execute-api.us-west-2.amazonaws.com/default/API2SES" method="POST">
			<input type="hidden" id="myhidden" name="send_to" value="hey@hotmail.com">
			...
			<fieldset>
				...
				<label for="phone">Phone number</label>
					<input type="tel" id="phone" name="phone" placeholder="are code">
			...
			<fieldset>
				...
				<label for="date">Requested  date</late>
				...
				<p>What type of UFO do you prefer?</p>
					...
					<label>
						<input type="radio" name="ufotype" value="viper">
						Battlestar Galactica-style Viper
					</label>
					<label>
						<input type="radio" name="ufotype" value="cube">
						Borg-style cube
					</label>
		...
		<aside>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2822.3043172905222!2d-93.27286938427672!3d44.97812877376525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x52b3329a75fc44b3%3A0xab6d15df00205abb!2s60%20South%206th%20St%2C%20Minneapolis%2C%20MN%2055402%2C%20USA!5e0!3m2!1sen!2sca!4v1651851895845!5m2!1sen!2sca" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
